...
const translations = {
  en: {
    ...
    app_signIn_button_createAccount: "Create Account",
    app_signIn_error_emailRequired: "Email is required",
    app_signIn_error_invalidEmail: "Please enter a valid email address",
    app_signIn_error_passwordRequired: "Password is required",
    // Firebase Auth Errors
    firebase_error_invalid_email: "Invalid email address format",
    firebase_error_user_disabled: "This account has been disabled",
    firebase_error_user_not_found: "No account found with this email",
    firebase_error_wrong_password: "Incorrect password",
    firebase_error_too_many_requests: "Too many failed login attempts. Please try again later",
    firebase_error_network_request_failed: "Network error. Please check your connection",
    firebase_error_email_already_in_use: "An account with this email already exists",
    firebase_error_operation_not_allowed: "Email/password accounts are not enabled",
    firebase_error_weak_password: "Password is too weak",
    firebase_error_requires_recent_login: "This operation requires a recent login. Please sign in again",
    firebase_error_account_exists_with_different_credential: "An account already exists with the same email but different sign-in credentials",
    firebase_error_generic: "Authentication failed. Please try again",
    // Project-related error messages
    project_error_name_required: "Project name is required",
    project_error_id_required: "Project ID is required",
    project_error_user_id_required: "User ID is required",
    project_error_user_not_authenticated: "You must be logged in to perform this action",
    project_error_permission_denied: "You don't have permission to perform this action",
    project_error_not_found: "Project not found",
    project_error_already_exists: "A project with this name already exists",
    project_error_invalid_argument: "Invalid project information provided",
    project_error_not_manager: "Only project managers can perform this action",
    project_error_unknown: "An unknown error occurred while managing the project",
    // Release-related error messages
    release_error_name_required: "Release name cannot be empty. Please enter a name for the release.",
    // Task-related error messages
    task_error_name_required: "Task name cannot be empty. Please enter a name for the task.",
    // Sign Up
    ...
    app_signUp_error_nameRequired: "First name is required",
    app_signUp_error_lastNameRequired: "Last name is required",
    app_signUp_error_emailRequired: "Email is required",
    app_signUp_error_invalidEmail: "Please enter a valid email address",
    app_signUp_error_passwordRequired: "Password is required",
    app_signUp_error_passwordTooShort: "Password must be at least 6 characters",
    app_signUp_error_signInAfterSignUp: "Account created successfully, but sign-in failed. Please try signing in manually.",
    // Not Found
    ...
    app_innerScreens_projectReleases_toast_releaseCreated: "Release created successfully!",
    // Edit Release
  ...
  pl: {
    ...
    app_signIn_button_createAccount: "Utwórz konto",
    app_signIn_error_emailRequired: "Email jest wymagany",
    app_signIn_error_invalidEmail: "Wprowadź poprawny adres email",
    app_signIn_error_passwordRequired: "Hasło jest wymagane",
    // Firebase Auth Errors
    firebase_error_invalid_email: "Nieprawidłowy format adresu email",
    firebase_error_user_disabled: "To konto zostało wyłączone",
    firebase_error_user_not_found: "Nie znaleziono konta z tym adresem email",
    firebase_error_wrong_password: "Nieprawidłowe hasło",
    firebase_error_too_many_requests: "Zbyt wiele nieudanych prób logowania. Spróbuj ponownie później",
    firebase_error_network_request_failed: "Błąd sieci. Sprawdź swoje połączenie",
    firebase_error_email_already_in_use: "Konto z tym adresem email już istnieje",
    firebase_error_operation_not_allowed: "Logowanie za pomocą emaila i hasła jest wyłączone",
    firebase_error_weak_password: "Hasło jest zbyt słabe",
    firebase_error_requires_recent_login: "Ta operacja wymaga niedawnego logowania. Zaloguj się ponownie",
    firebase_error_account_exists_with_different_credential: "Konto z tym samym adresem email już istnieje, ale z innymi danymi logowania",
    firebase_error_generic: "Uwierzytelnianie nie powiodło się. Spróbuj ponownie",
    // Project-related error messages
    project_error_name_required: "Nazwa projektu jest wymagana",
    project_error_id_required: "ID projektu jest wymagane",
    project_error_user_id_required: "ID użytkownika jest wymagane",
    project_error_user_not_authenticated: "Musisz być zalogowany, aby wykonać tę akcję",
    project_error_permission_denied: "Nie masz uprawnień do wykonania tej akcji",
    project_error_not_found: "Nie znaleziono projektu",
    project_error_already_exists: "Projekt o tej nazwie już istnieje",
    project_error_invalid_argument: "Podano nieprawidłowe informacje o projekcie",
    project_error_not_manager: "Tylko menedżerowie projektu mogą wykonać tę akcję",
    project_error_unknown: "Wystąpił nieznany błąd podczas zarządzania projektem",
    // Release-related error messages
    release_error_name_required: "Nazwa wydania nie może być pusta. Proszę wprowadzić nazwę dla wydania.",
    // Task-related error messages
    task_error_name_required: "Nazwa zadania nie może być pusta. Proszę wprowadzić nazwę dla zadania.",
    // Sign Up
    ...
    app_signUp_error_nameRequired: "Imię jest wymagane",
    app_signUp_error_lastNameRequired: "Nazwisko jest wymagane",
    app_signUp_error_emailRequired: "Email jest wymagany",
    app_signUp_error_invalidEmail: "Wprowadź poprawny adres email",
    app_signUp_error_passwordRequired: "Hasło jest wymagane",
    app_signUp_error_passwordTooShort: "Hasło musi mieć co najmniej 6 znaków",
    app_signUp_error_signInAfterSignUp: "Konto zostało utworzone pomyślnie, ale logowanie nie powiodło się. Spróbuj zalogować się ręcznie.",
    // Not Found
    ...
    app_innerScreens_projectReleases_input_releaseDescriptionPlaceholder: "Opis wydania (opcjonalnie)",
    ...
    app_innerScreens_projectReleases_toast_releaseCreated: "Wydanie utworzone pomyślnie!",
    // Edit Release
    app_innerScreens_editRelease_input_releaseNamePlaceholder: "Nazwa wydania",
    app_innerScreens_editRelease_input_releaseDescriptionPlaceholder: "Opis wydania (opcjonalnie)",
